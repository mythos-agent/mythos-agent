...
This file lists the active maintainers of mythos-agent. Maintainer responsibilities, the path to becoming one, and the multi-phase governance evolution are described in [GOVERNANCE.md](./GOVERNANCE.md).
...
1. Open a [GitHub Discussion](https://github.com/mythos-agent/mythos-agent/discussions) titled `[CONTINUITY]` describing the situation
