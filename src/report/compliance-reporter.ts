...
const FRAMEWORKS: Record<string, Array<{ id: string; description: string; categories: string[] }>> = {
  "SOC2": [
    { id: "CC6.1", description: "Logical and Physical Access Controls", categories: ["injection", "xss", "auth"] },
    { id: "CC6.2", description: "System Operations — Security Monitoring", categories: ["secrets", "config"] },
    { id: "CC6.6", description: "Confidentiality — Encryption", categories: ["crypto"] },
    { id: "CC6.7", description: "Confidentiality — Data Transmission", categories: ["crypto", "config"] },
  ...
  "HIPAA": [
    { id: "§164.312(a)(1)", description: "Access Control", categories: ["injection", "auth", "access-control"] },
    { id: "§164.312(a)(2)(iv)", description: "Encryption and Decryption", categories: ["crypto", "secrets"] },
    ...
    { id: "§164.312(e)(1)", description: "Transmission Security", categories: ["crypto", "config"] },
  ],
  "PCI-DSS": [
    ...
    { id: "Req 6.5.8", description: "Improper Access Control", categories: ["auth", "access-control"] },
  ...
  "OWASP": [
    { id: "A01:2021", description: "Broken Access Control", categories: ["auth", "access-control", "redirect"] },
    ...
    { id: "A08:2021", description: "Software and Data Integrity", categories: ["dependency", "config"] },
...
export function generateComplianceReport(
  ...
  for (const framework of frameworks) {
    ...
    const controls: ComplianceControl[] = controlDefs.map((ctrl) => {
      const relatedFindings = vulns.filter((v) =>
        ctrl.categories.includes(v.category)
      );
