...
const LOG_RULES: Array<{
...
}> = [
  {
    ...
    description:
      "User input logged without sanitization. Attackers can inject fake log entries, break log parsing, or exploit log viewers.",
    severity: "medium",
    cwe: "CWE-117",
    patterns: [
  ...
  },
  {
    ...
    description:
      "Passwords, tokens, or secrets may be written to logs. Redact sensitive fields before logging.",
    severity: "high",
    cwe: "CWE-532",
    patterns: [
  ...
  },
  {
    ...
    description:
      "Authentication or authorization events not logged. Security monitoring requires logging login attempts, access denials, and privilege changes.",
    severity: "medium",
    cwe: "CWE-778",
    patterns: [
  ...
  },
  {
    ...
    description:
      "Internal error details (file paths, SQL, stack) sent to user AND logged. Log details internally, send generic message to user.",
    severity: "medium",
    cwe: "CWE-209",
    patterns: [
  ...
  },
  {
    ...
    description:
      "console.log used for logging in production. Use a structured logger (winston, pino, bunyan) with log levels.",
    severity: "low",
    cwe: "CWE-778",
    patterns: [/console\.log\s*\(\s*(?!.*(?:test|debug|TODO|FIXME))/gi],
  },
];
